...
date: 2020/01/17 22:54:43
updated: 2020/01/17 22:54:43
categories:
- [技术, 翻译转载]
tags:
- 转载
...
![img](./assets/c527ac282e3203015720b5c9bb29043806839b73.png)
...
![img](./assets/d4303aaa6f0a3993ffd302b6a4b6200d058642b1.png)
...
![img](./assets/df517f98621ce485e61d0fd1dcfe454569ab616c.png)

![img](./assets/3bb896b71c93d6b398df2e5758c7b24d8d60ce5d.png)
...
![img](./assets/5ce6d4e792b0602ace43d2fe5fd22fc396a3df6d.png)

  

![img](./assets/2c8b31fe93d10d59f8e026005ed31d2c2cc88c46.png)
...
![img](./assets/5728b58a8d2cf6c2be789bca5acbb77dde9c4d4c.png)



Kubernetes 的 Master 包含四个主要的组件：API Server、Controller、Scheduler 以及 etcd。如下图所示：

![img](./assets/b161e11eae280d950de7259873193f1a9359b97f.png)
...
![img](./assets/9dbdfbe3b7068f32d95b02dc2dd29302c82c9e3e.png)
...
![img](./assets/c5cad06a9318860017d56ee709ddba6650941ec0.png)
...
![img](./assets/616cc75b2ce8d734d6389f521c16f4d1d6f56dff.png)
...
![img](./assets/5d7c4142358a29dee77740cb9ebe978b04aec2eb.png)
...
![img](./assets/70fdf18aac3c814fff9c0a6f2a83dd9eed29f387.png)
...
![img](./assets/ac386185dd887052ed3236a05c82cb9e565733fd.png)
...
![img](./assets/8995bce3a619f4e182fd65410ddddf477cbf869a.png)
...
![img](./assets/9f2ba062136191e31834a2c2b7f7439cedee5d52.png)
...
第一个部分，一般来讲会是 API 的 version。比如在这个例子中是 V1，它也会描述我在操作哪个资源；比如说我的 kind如果是 pod，在 Metadata 中，就写上这个 Pod 的名字；比如说 nginx，我们也会给它打一些 label，我们等下会讲到 label 的概念。在 Metadata 中，有时候也会去写 annotation，也就是对资源的额外的一些用户层次的描述。
...
![img](./assets/e527e99921303d9bd9457a098da31d83fc8b8e74.png)
...
![img](./assets/5394b7b26ec1b134501533f0dc00f6f5580ae525.png)



下一步我们利用 kubectl 来看一下这个集群中节选的状态，可以看到这个master 的节点已经是running状态：

![img](./assets/54fac1c5eb76db2f8409e888d595151571d6288c.png)



我们就以这个为节点，下面我们尝试去看一下现在集群中 Deployment 这个资源：

![img](./assets/080068ebf0f94e145d04bb34cadc3b77b0d365ff.png)
...
![img](./assets/ba972a30cb83222a37fbd3b08956b75226aefc59.png)

![img](./assets/92234b488d9e59b1e46469c5d2454dc5a54f5be8.png)



我们下面还是回到 kubectl 这个 commnd 来执行这次 Deployment 的真正的操作。我们可以看到一个简单的操作，就会去让 Deployment 不停地生成副本。

![img](./assets/523aedddd93eb0f7eea35175a352ac5138c637d0.png)
...
![img](./assets/46650884c993437cb2221a5c6d500e770962c0f8.png)



下面我们去升级这个 Deployment 版本，首先下载另外一个 yaml 文件 deployment-update.yaml，可以看到这里面的 image 本身的版本号从 1.7.9 升级到 1.8。

![img](./assets/e818958afc9134d38c3b268cdc6c2f5f357b3532.png)
...
![img](./assets/3a48ceac3b08a99f6881a52bc06191f2a1378137.png)



最后我们演示一下给 Deployment 做水平扩张，下载另一个 yaml 文件 deployment-scale.yaml，这里面的 replicas 数目已经从 2 改成了 4。

![img](./assets/6548fa86926f44c92ce6c319a86c81d2d968e8d5.png)
...
![img](./assets/e377ed7b0a8884f758e614e5034d22280c9b5222.png)
...
![img](./assets/605065468f68e9a9b3477a582dfefc2c6166765f.png)
...
- [Kubernetes核心概念](https://edu.aliyun.com/course/314164/lesson/341312172)